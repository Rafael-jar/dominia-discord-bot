...
module.exports.run = async (bot, message, args, tools) => {
    ...
    db.set(`workmin`, args[0])
    message.channel.send(`<:confirm:534355831982915609> Vous avez changé le minimum d'argent gagné avec la commande work vers ${args[0]} il était à ${min}`)
