...
module.exports.run = async (bot, message, args, tools) => {
    ...
    db.set(`volmin`, args[0])
    message.channel.send(`<:confirm:534355831982915609> Vous avez changé le minimum d'argent gagné/perdu avec la commande vol vers ${args[0]} il était à ${min}`)
