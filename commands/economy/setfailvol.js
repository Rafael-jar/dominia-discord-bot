...
module.exports.run = async (bot, message, args, tools) => {
    ...
    db.set(`failvol`, args[0])
    message.channel.send(`<:confirm:534355831982915609> Vous avez changé le pourcentage de fail avec la commande vol vers ${args[0]} et était à ${fail}`)
