...
module.exports.run = async (bot, message, args, tools) => {
    ...
    db.set(`crimemax`, args[0])
    message.channel.send(`<:confirm:534355831982915609> Vous avez changé le maximum d'argent gagné/perdu avec la commande crime vers ${args[0]} il était à ${max}`)
